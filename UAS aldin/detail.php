...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <a class="navbar-brand" href="index.php">
            <img src="img/log1o.png" alt="" width="150" srcset="">
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="search.php?keyword=animated">Animated</a>
    ...
    ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10">
                    <h1 class="fc"><?php echo $data['title']; ?></h1>
                    ...
                    <p class="fc"><?php echo $data['plot']; ?> | <?php echo $data['summary']; ?>

                    </p>

                    <b class="fc">Negara :</b><span><?php echo $data['orign_country']; ?></span><br>
                    <b class="fc">Pemain :</b><span>
                        <div id="cast"></div>
                    </span>
<script>
